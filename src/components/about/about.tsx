            ...
            >
              <VStack marginTop="2rem" width="45%">
                <PortfolioTextStandard color="white">
                  ...
                  React, Chakra, FashAPI, and Flask. I've spearheaded the
                  building and design of a variety of web apps utilizing
                  concepts from social media, payments, image and video
                  handling, conversation flows, responsive designs, APIs, 3rd
                  party integrations, 3D layouts and animation on both the front
                  and backend levels of web design.
                </PortfolioTextStandard>
